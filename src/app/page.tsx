      ...
      <main className="flex-grow flex flex-col items-center h-full relative pt-20">
          ...
          >
            ...
            >
              <p className="text-gray-300 md:text-lg text-base leading-relaxed mb-4">
                ...
                with 3+ years of experience in web development. I&apos;m from
        ...
        >
          <BlurText
            ...
            direction="top"
            onAnimationComplete={handleAnimationComplete}
            className="md:text-7xl text-3xl font-extrabold bg-gradient-to-r from-white via-purple-200 to-pink-300 bg-clip-text text"
          />
        </motion.div>
        <motion.div
